    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g. Mild redness at injection site"
            className="h-11 w-full rounded-md border border-[#1f4470] bg-[#102849] px-4 text-sm text-[#dcecff]"
          />
        </div>
      </div>
      ...
      <div className="flex justify-end gap-3 pt-4 border-t border-white/10">
        <button
          type="button"
          onClick={onClose}
          className="px-4 py-2 text-sm font-medium text-[#7fa3cb] hover:text-[#edf5ff]"
        >
          Cancel
        </button>
        <button
          type="submit"
          disabled={submitting}
          className="rounded-md bg-[#00a884] px-4 py-2 text-sm font-medium text-white hover:bg-[#008f70] disabled:opacity-50"
        >
