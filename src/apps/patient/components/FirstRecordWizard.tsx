...
//   },
  ...
  {
    id: "File",
    label: "Other Document/Imaging",
    icon: FileText,
    color: "#14b8a6",
    desc: "Referrals, discharge letters, etc.",
  },
];
      ...
      >
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="font-bold text-sm" style={{ color: "#1a2e1e" }}>
        ...
        <div className="flex gap-1.5 px-6 py-3">
          {STEPS.map((_, i) => (
            <div
              ...
              style={{
                background: i <= step ? "#1a6b42" : "rgba(26,107,66,0.12)",
              }}
            />
          ))}
        </div>
        ...
        <div className="px-6 pb-6" style={{ minHeight: "320px" }}>
            ...
            <div className="animate-fade-in">
              <div className="text-center pt-4 pb-6">
                <div
                  ...
                  style={{
                    background: "linear-gradient(135deg,#1a6b42,#2d9d63)",
                  }}
                >
                ...
                <p
                  ...
                  style={{ color: "#5a7a63" }}
                >
                  Your <strong>WelliFile</strong> is a single, encrypted,
                  portable container of your entire medical history — lab
                  results, prescriptions, scans, and more. It belongs to you,
                  not any hospital or clinic.
                </p>
              </div>
              ...
              <div className="space-y-3">
                {[
                  {
                    icon: ShieldCheck,
                    text: "End-to-end encrypted & stored securely on-device",
                    color: "#1a6b42",
                  },
                  {
                    icon: Sparkles,
                    text: "Share with any provider in seconds via QR code",
                    color: "#8b5cf6",
                  },
                  {
                    icon: HardDrive,
                    text: "Export as FHIR, PDF, or QR — you always own it",
                    color: "#3b82f6",
                  },
              ...
              <button
                onClick={() => setStep(1)}
                className="bg-blue-800 w-full text-white mt-6 gap-2 flex items-center py-3 justify-center rounded-3xl"
              >
          ...
          {step === 1 && (
            <div className="animate-fade-in">
              <h2
                className="font-bold text-base mb-1 pt-2"
                style={{ color: "#1a2e1e" }}
              >
                ...
                {RECORD_TYPES.map(({ id, label, icon: Icon, color, desc }) => (
                  <button
                    ...
                    style={{
                      ...
                      background:
                        selectedType === id ? `${color}0e` : "#fafafa",
                    }}
                  >
                    <div
            ...
            <div className="animate-fade-in">
              ...
              >
                ...
                <div className="text-center">
                  ...
                  >
                    Drop file here or{" "}
                    <span style={{ color: "#1a6b42" }}>browse</span>
                  </p>
          ...
          {step === 3 && (
            <div className="animate-fade-in text-center pt-4">
              ...
              >
                {fileName ? (
                  <>
                    <strong>{fileName}</strong> has been
                  </>
                ) : (
                  "Your record has been"
                )}{" "}
                securely added to your Health Vault and verified on the
                WelliChain.
              </p>

              <div
                className="my-5 p-4 rounded-2xl text-left"
                style={{
                  background: "rgba(26,107,66,0.06)",
              ...
              >
                ...
                <p className="text-xs" style={{ color: "#5a7a63" }}>
                  This record's hash is stored on the WelliChain ledger —
                  tamper-proof and timestamped forever.
                </p>
              </div>
...
export const RecordModal: React.FC<RecordModalProps> = ({ type, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-xl p-6 max-w-[600px] max-h-[80vh] overflow-y-auto relative shadow-lg">
