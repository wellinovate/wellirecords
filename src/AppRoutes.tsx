...
export function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/auth/provider/verify-org" element={<OrgVerificationPage />} />
      ...
      >
        ...
        {/* System */}
        <Route path="system-health" element={<SystemHealthPage />} />
        <Route path="feature-flags" element={<SuperAdminPlaceholder title="Feature Flags" description="Toggle platform features and conduct staged rollouts." />} />
        <Route path="api-status" element={<SuperAdminPlaceholder title="API Status" description="Monitor external integrations and partner API health." />} />
        <Route path="notifications" element={<SuperAdminPlaceholder title="Notifications" description="Configure global system notification rules." />} />
        <Route path="broadcast" element={<NotificationTemplatesPage />} />
