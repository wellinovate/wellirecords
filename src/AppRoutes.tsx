...
// ─── Blog Page (lazy) ─────────────────────────────────────────────────────────
const BlogPage = lazy(() =>
  import("@/apps/public/pages/BlogPage").then((m) => ({ default: m.BlogPage })),
);
const BlogAdminPage = lazy(() =>
  import("@/apps/admin/pages/BlogAdminPage").then((m) => ({
    default: m.BlogAdminPage,
  })),
);
const BlogManagementPage = lazy(() =>
  import("@/apps/admin/pages/BlogManagementPage").then((m) => ({
    default: m.BlogManagementPage,
  })),
);

// ─── Auth Pages (lazy) ────────────────────────────────────────────────────────
const AuthGatewayPage = lazy(() =>
  import("@/apps/auth/pages/AuthGatewayPage").then((m) => ({
    default: m.AuthGatewayPage,
  })),
);
const PatientLoginPage = lazy(() =>
  import("@/apps/auth/pages/PatientLoginPage").then((m) => ({
    default: m.PatientLoginPage,
  })),
);
const ProviderLoginPage = lazy(() =>
  import("@/apps/auth/pages/ProviderLoginPage").then((m) => ({
    default: m.ProviderLoginPage,
  })),
);
const ProviderSignupPage = lazy(() =>
  import("@/apps/auth/pages/ProviderSignupPage").then((m) => ({
    default: m.ProviderSignupPage,
  })),
);
const OrgVerificationPage = lazy(() =>
  import("@/apps/auth/pages/OrgVerificationPage").then((m) => ({
    default: m.OrgVerificationPage,
  })),
);
const VerifyEmailPage = lazy(() =>
  import("@/apps/auth/pages/VerifyEmailPage").then((m) => ({
...
const AcceptInvitePage = lazy(() =>
  import("@/apps/public/pages/AcceptInvitePage").then((m) => ({
    default: m.AcceptInvitePage,
  })),
);
const SuperAdminLoginPage = lazy(() =>
  import("@/apps/auth/pages/SuperAdminLoginPage").then((m) => ({
    default: m.SuperAdminLoginPage,
  })),
);
const UserTypeSelection = lazy(
  () => import("./apps/auth/pages/UserTypeSelection"),
);
const PatientSignupPage = lazy(
  () => import("./apps/auth/pages/PatientSignupPage"),
);
const PatientSignupSuccessPage = lazy(() =>
  import("@/apps/auth/pages/PatientSignupSuccessPage").then((m) => ({
    default: m.PatientSignupSuccessPage,
  })),
);
const ProviderSignupSuccessPage = lazy(() =>
  import("@/apps/auth/pages/ProviderSignupSuccessPage").then((m) => ({
    default: m.ProviderSignupSuccessPage,
  })),
);
const UserTypeSelectionLogin = lazy(
  () => import("./apps/auth/pages/UserTypeSelectionLogin"),
);

// ─── Patient Portal (lazy — largest chunk) ───────────────────────────────────
const PatientLayout = lazy(() =>
  import("@/apps/patient/layouts/PatientLayout").then((m) => ({
    default: m.PatientLayout,
  })),
);

const PatientOverview = lazy(() =>
  import("@/apps/patient/pages/PatientOverview").then((m) => ({
    default: m.PatientOverview,
  })),
);
const PatientVisionPage = lazy(() =>
  import("@/apps/patient/pages/PatientVisionPage").then((m) => ({
    default: m.PatientVisionPage,
  })),
);
const HealthVaultPage = lazy(() =>
  import("@/apps/patient/pages/HealthVaultPage").then((m) => ({
    default: m.HealthVaultPage,
  })),
);
const CareJourneysPage = lazy(() =>
  import("@/apps/patient/pages/CareJourneysPage").then((m) => ({
    default: m.CareJourneysPage,
  })),
);
const DataSovereigntyCenterPage = lazy(() =>
  import("@/apps/patient/pages/DataSovereigntyCenterPage").then((m) => ({
    default: m.DataSovereigntyCenterPage,
  })),
);
const EmergencyCardPage = lazy(() =>
  import("@/apps/patient/pages/EmergencyCardPage").then((m) => ({
    default: m.EmergencyCardPage,
  })),
);
const AppointmentsPage = lazy(() =>
  import("@/apps/patient/pages/AppointmentsPage").then((m) => ({
    default: m.AppointmentsPage,
  })),
);
const MessagesPage = lazy(() =>
  import("@/apps/patient/pages/MessagesPage").then((m) => ({
    default: m.MessagesPage,
  })),
);
const PatientSettingsPage = lazy(() =>
  import("@/apps/patient/pages/PatientSettingsPage").then((m) => ({
    default: m.PatientSettingsPage,
  })),
);
const FindCarePage = lazy(() =>
  import("@/apps/patient/pages/FindCarePage").then((m) => ({
...
const ChildProfilePage = lazy(() =>
  import("@/apps/patient/pages/ChildProfilePage").then((m) => ({
    default: m.ChildProfilePage,
  })),
);
const TelemedicineHubPage = lazy(() =>
  import("@/apps/patient/pages/TelemedicineHubPage").then((m) => ({
    default: m.TelemedicineHubPage,
  })),
);
const SmartSymptomIntakePage = lazy(() =>
  import("@/apps/patient/pages/SmartSymptomIntakePage").then((m) => ({
    default: m.SmartSymptomIntakePage,
  })),
);
const TeleconsultRoomPage = lazy(() =>
  import("@/apps/patient/pages/TeleconsultRoomPage").then((m) => ({
    default: m.TeleconsultRoomPage,
  })),
);
const MedicationsPage = lazy(() =>
  import("@/apps/patient/pages/MedicationsPage").then((m) => ({
    default: m.MedicationsPage,
  })),
);
const BillingPatientPage = lazy(() =>
  import("@/apps/patient/pages/BillingPatientPage").then((m) => ({
    default: m.BillingPatientPage,
  })),
);
const PatientSupportPage = lazy(() =>
  import("@/apps/patient/pages/PatientSupportPage").then((m) => ({
    default: m.PatientSupportPage,
  })),
);
const HealthCategoryHistoryPage = lazy(() =>
  import("./apps/components/HealthCategoryHistoryPage").then((m) => ({
    default: m.HealthCategoryHistoryPage,
  })),
);
const HealthHistoryTimelinePage = lazy(() =>
  import("./apps/patient/pages/HealthHistory").then((m) => ({
    default: m.HealthHistoryTimelinePage,
  })),
);

// ─── Provider Portal (lazy) ───────────────────────────────────────────────────
const ProviderLayout = lazy(() =>
  import("@/apps/provider/layouts/ProviderLayout").then((m) => ({
    default: m.ProviderLayout,
  })),
);
const ProviderDashboard = lazy(() =>
  import("@/apps/provider/pages/ProviderDashboard").then((m) => ({
...
const EHRViewerPage = lazy(() =>
  import("@/apps/provider/pages/EHRViewerPage").then((m) => ({
    default: m.EHRViewerPage,
  })),
);
const NewEncounterPage = lazy(() =>
  import("@/apps/provider/pages/NewEncounterPage").then((m) => ({
    default: m.NewEncounterPage,
  })),
);
const LabOrdersPage = lazy(() =>
  import("@/apps/provider/pages/LabOrdersPage").then((m) => ({
    default: m.LabOrdersPage,
  })),
);
const PrescriptionsPage = lazy(() =>
  import("@/apps/provider/pages/PrescriptionsPage").then((m) => ({
...
const ProviderVisionPage = lazy(() =>
  import("@/apps/provider/pages/ProviderVisionPage").then((m) => ({
    default: m.ProviderVisionPage,
  })),
);
const ReferralsPage = lazy(() =>
  import("@/apps/provider/pages/ReferralsPage").then((m) => ({
    default: m.ReferralsPage,
  })),
);
const ProviderInsurancePage = lazy(() =>
  import("@/apps/provider/pages/ProviderInsurancePage").then((m) => ({
    default: m.ProviderInsurancePage,
  })),
);
const TeamManagementPage = lazy(() =>
  import("@/apps/provider/pages/TeamManagementPage").then((m) => ({
...
const IntegrationsPage = lazy(() =>
  import("@/apps/provider/pages/IntegrationsPage").then((m) => ({
    default: m.IntegrationsPage,
  })),
);
const PublicHealthDashboard = lazy(() =>
  import("@/apps/provider/pages/PublicHealthDashboard").then((m) => ({
    default: m.PublicHealthDashboard,
  })),
);
const ProviderTelemedicinePage = lazy(() =>
  import("@/apps/provider/pages/ProviderTelemedicinePage").then((m) => ({
    default: m.ProviderTelemedicinePage,
  })),
);
const TeleConsultSessionPage = lazy(() =>
  import("@/apps/provider/pages/TeleConsultSessionPage").then((m) => ({
    default: m.TeleConsultSessionPage,
  })),
);
const NursePage = lazy(() =>
  import("@/apps/provider/pages/NursePage").then((m) => ({
    default: m.NursePage,
  })),
);
const RadiologyPage = lazy(() =>
  import("@/apps/provider/pages/RadiologyPage").then((m) => ({
...
const HMODeskPage = lazy(() =>
  import("@/apps/provider/pages/HMODeskPage").then((m) => ({
    default: m.HMODeskPage,
  })),
);
const ReportsPage = lazy(() =>
  import("@/apps/provider/pages/ReportsPage").then((m) => ({
    default: m.ReportsPage,
  })),
);
const AppointmentQueuePage = lazy(() =>
  import("@/apps/provider/pages/AppointmentQueuePage").then((m) => ({
    default: m.AppointmentQueuePage,
  })),
);
const ProviderSupportPage = lazy(() =>
  import("@/apps/provider/pages/ProviderSupportPage").then((m) => ({
...
const PatientImportPage = lazy(() =>
  import("@/apps/provider/pages/PatientImportPage").then((m) => ({
    default: m.PatientImportPage,
  })),
);
...
const AdminLayout = lazy(() =>
  import("@/apps/admin/layouts/AdminLayout").then((m) => ({
    default: m.AdminLayout,
  })),
);
const AdminDashboard = lazy(() =>
  import("@/apps/admin/pages/AdminDashboard").then((m) => ({
    default: m.AdminDashboard,
  })),
);
const VerificationQueuePage = lazy(() =>
  import("@/apps/admin/pages/VerificationQueuePage").then((m) => ({
    default: m.VerificationQueuePage,
  })),
);
const VerificationDetailPage = lazy(() =>
  import("@/apps/admin/pages/VerificationDetailPage").then((m) => ({
    default: m.VerificationDetailPage,
  })),
);
const PatientRegistryPage = lazy(() =>
  import("@/apps/admin/pages/PatientRegistryPage").then((m) => ({
    default: m.PatientRegistryPage,
  })),
);
const FacilityRegistryPage = lazy(() =>
  import("@/apps/admin/pages/FacilityRegistryPage").then((m) => ({
    default: m.FacilityRegistryPage,
  })),
);
const BillingDashboardPage = lazy(() =>
  import("@/apps/admin/pages/BillingDashboardPage").then((m) => ({
    default: m.BillingDashboardPage,
  })),
);
const SubscriptionPlansPage = lazy(() =>
  import("@/apps/admin/pages/SubscriptionPlansPage").then((m) => ({
    default: m.SubscriptionPlansPage,
  })),
);
const NotificationTemplatesPage = lazy(() =>
  import("@/apps/admin/pages/NotificationTemplatesPage").then((m) => ({
    default: m.NotificationTemplatesPage,
  })),
);
const PlatformAuditPage = lazy(() =>
  import("@/apps/admin/pages/PlatformAuditPage").then((m) => ({
    default: m.PlatformAuditPage,
  })),
);
const SecurityAlertsPage = lazy(() =>
  import("@/apps/admin/pages/SecurityAlertsPage").then((m) => ({
    default: m.SecurityAlertsPage,
  })),
);
const ConsentGovernancePage = lazy(() =>
  import("@/apps/admin/pages/ConsentGovernancePage").then((m) => ({
    default: m.ConsentGovernancePage,
  })),
);
const SupportDeskPage = lazy(() =>
  import("@/apps/admin/pages/SupportDeskPage").then((m) => ({
    default: m.SupportDeskPage,
  })),
);
const TicketDetailPage = lazy(() =>
  import("@/apps/admin/pages/TicketDetailPage").then((m) => ({
    default: m.TicketDetailPage,
  })),
);
const AuditSearchPage = lazy(() =>
  import("@/apps/admin/pages/AuditSearchPage").then((m) => ({
    default: m.AuditSearchPage,
  })),
);
const DataRetentionPage = lazy(() =>
  import("@/apps/admin/pages/DataRetentionPage").then((m) => ({
    default: m.DataRetentionPage,
  })),
);
const PermissionHistoryPage = lazy(() =>
  import("@/apps/admin/pages/PermissionHistoryPage").then((m) => ({
    default: m.PermissionHistoryPage,
  })),
);
const SessionControlsPage = lazy(() =>
  import("@/apps/admin/pages/SessionControlsPage").then((m) => ({
    default: m.SessionControlsPage,
  })),
);
const IncidentLogPage = lazy(() =>
  import("@/apps/admin/pages/IncidentLogPage").then((m) => ({
    default: m.IncidentLogPage,
  })),
);
const SystemHealthPage = lazy(() =>
  import("@/apps/admin/pages/SystemHealthPage").then((m) => ({
...
const SuperAdminLayout = lazy(() =>
  import("@/apps/superadmin/layouts/SuperAdminLayout").then((m) => ({
    default: m.SuperAdminLayout,
  })),
);
const SuperAdminDashboard = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminDashboard").then((m) => ({
    default: m.SuperAdminDashboard,
  })),
);
const SuperAdminPlaceholder = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminPlaceholder").then((m) => ({
    default: m.SuperAdminPlaceholder,
  })),
);
const SuperAdminPlatformUsers = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminPlatformUsers").then((m) => ({
    default: m.SuperAdminPlatformUsers,
  })),
);
const SuperAdminPlatformSettings = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminPlatformSettings").then((m) => ({
    default: m.SuperAdminPlatformSettings,
  })),
);
const SuperAdminOrganisations = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminOrganisations").then((m) => ({
    default: m.SuperAdminOrganisations,
  })),
);
const SuperAdminRoleManager = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminRoleManager").then((m) => ({
    default: m.SuperAdminRoleManager,
  })),
);
const SuperAdminRevenue = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminRevenue").then((m) => ({
    default: m.SuperAdminRevenue,
  })),
);
const SuperAdminImpersonations = lazy(() =>
  import("@/apps/superadmin/pages/SuperAdminImpersonations").then((m) => ({
    default: m.SuperAdminImpersonations,
  })),
);
  ...
  return (
    <Suspense fallback={<PageLoader />}>
      <Routes>
        ...
        <Route path="/verify/:token" element={<VerifyInvoicePage />} />
        ...
        <Route
          ...
          element={<Navigate to="/auth/super-admin/login" replace />}
        />
        ...
        >
          ...
          <Route
            path="vault/:category"
            element={<HealthCategoryHistoryPage />}
          />
        ...
        >
          ...
          <Route path="insurance" element={<ProviderInsurancePage />} />
        ...
        >
          ...
          <Route
            path="consent-governance"
            element={<ConsentGovernancePage />}
          />
