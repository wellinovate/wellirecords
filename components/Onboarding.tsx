...
const FEATURES = [
    {
        ...
        details: 'WelliRecord is built on the HL7 FHIR standard, ensuring your health data speaks the global language of healthcare. Whether you are seeing a specialist in London or an emergency room in Lagos, your critical health information is instantly available and readable.',
        benefits: [
    ...
    },
    {
        ...
        details: 'Our "Smart Consent" protocol puts you in the driver’s seat. Grant granular permissions—share just your latest MRI with a radiologist or your full history with a new GP. Set automatic expiration timers so you never have to remember to revoke access.',
        benefits: [
    ...
    },
    {
        ...
        details: 'WelliRecord doesn’t just store clinical data; it brings it to life with real-world context. Sync data from Apple Health, Google Fit, and Oura. Our Gemini 2.5 AI engine analyzes your sleep, heart rate variability, and activity alongside your lab results to find hidden correlations.',
        benefits: [
...
export const Onboarding: React.FC<Props> = ({ onComplete }) => {
  ...
  const [activeSecurityFeature, setActiveSecurityFeature] = useState<'certificate' | 'whitepaper' | 'network' | null>(null);
  ...
  const [walletStatus, setWalletStatus] = useState<'idle' | 'connecting' | 'checking' | 'deploying' | 'connected'>('idle');
  ...
  const [contractStatus, setContractStatus] = useState<'idle' | 'compiling' | 'deploying' | 'minting' | 'done'>('idle');
...
const API_URL = "https://welli-record.vercel.app";
  ...
  const handleSignupStep1 = () => {
      ...
      setTouched({ name: true, email: true, phone: true, password: true, nin: false });
      ...
      setTimeout(() => {
          ...
          setTimeout(() => {
              ...
              setTimeout(() => {
                  ...
                  setGeneratedAddress(`0x${Array.from({length: 40}, () => Math.floor(Math.random() * 16).toString(16)).join('')}`);
                  setRecoveryPhrase("witch collapse practice feed shame open despair creek road again ice least");
              }, 2000);
          }, 2000);
      }, 1500);
  };
      ...
      setTimeout(() => {
          ...
          setTimeout(() => {
              ...
              setTimeout(() => {
                  ...
                  setTimeout(() => {
                      onComplete({ name: 'Wallet User', email: 'wallet@wellichain.eth', memberId: 'WR-SMART-99' });
                  }, 1000);
              }, 2500);
          }, 1500);
      }, 1500);
  ...
  const renderSalesContact = () => (
    <div className="fixed inset-0 z-50 bg-slate-900/80 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in duration-300">
        <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden relative flex flex-col max-h-[90vh]">
            <button 
                onClick={() => { setShowSalesContact(false); setSalesSubmitted(false); }}
            ...
            {salesSubmitted ? (
                <div className="p-12 text-center flex flex-col items-center justify-center h-full">
                    ...
                    <p className="text-slate-500 mb-8 max-w-xs">
                        Thank you for your interest in WelliRecord Enterprise. Our sales team will contact you at <strong>{salesForm.email}</strong> within 24 hours.
                    </p>
                    <button 
                        onClick={() => { setShowSalesContact(false); setSalesSubmitted(false); setSalesForm({ name: '', email: '', company: '', message: '' }); }}
                ...
                <>
                    <div className="p-8 border-b border-slate-100 bg-slate-50/50">
                        ...
                        <p className="text-slate-500 text-sm mt-1">
                            Interested in deploying WelliRecord for your hospital, clinic, or insurance network? Let's talk.
                        </p>
                    </div>

                    <form onSubmit={handleSalesSubmit} className="p-8 space-y-4 overflow-y-auto">
                        ...
                        <div className="space-y-2">
                            <label className="text-xs font-bold text-slate-700 uppercase">How can we help?</label>
                            <textarea 
                                required
                                rows={4}
          ...
          return (
              <div className="fixed inset-0 z-50 bg-slate-950/90 backdrop-blur-md flex items-center justify-center p-4 animate-in fade-in zoom-in-95 duration-300">
                  <div className="bg-white text-slate-900 w-full max-w-2xl rounded-sm shadow-2xl relative flex flex-col max-h-[90vh]">
                      {/* Close */}
                      <button onClick={close} className="absolute -top-12 right-0 text-white/70 hover:text-white transition-colors">
                          <X size={32} />
                      </button>
                      ...
                      <div className="p-12 border-8 border-slate-100 h-full flex flex-col items-center text-center overflow-y-auto relative">
                          ...
                          <div className="mb-8">
                              ...
                              <h2 className="text-4xl font-serif font-bold text-slate-900 mb-2">Certificate of Compliance</h2>
                              <p className="text-slate-500 uppercase tracking-widest text-sm font-bold">WelliRecord Data Systems</p>
                          </div>

                          <div className="prose prose-slate max-w-lg mx-auto text-sm leading-relaxed mb-8">
                              <p>
                                  This document certifies that the <strong>WelliRecord™ Health Ecosystem</strong> has successfully passed all security audits and compliance verifications for the handling of Protected Health Information (PHI).
                              </p>
                              <p>
                                  The architecture strictly adheres to the data privacy and security mandates defined by:
                              </p>
                          </div>
                          ...
                          <div className="grid grid-cols-2 gap-6 w-full max-w-md mb-8">
                              <div className="border-2 border-slate-200 p-4 rounded-xl flex flex-col items-center bg-slate-50">
                                  ...
                                  <div className="text-[10px] text-slate-500 uppercase tracking-wide">Nitda Nigeria</div>
                                  <div className="mt-2 text-emerald-600"><CheckCircle size={20} /></div>
                              </div>
                              <div className="border-2 border-slate-200 p-4 rounded-xl flex flex-col items-center bg-slate-50">
                                  <div className="font-bold text-lg text-slate-900">HIPAA</div>
                                  <div className="text-[10px] text-slate-500 uppercase tracking-wide">United States</div>
                                  <div className="mt-2 text-emerald-600"><CheckCircle size={20} /></div>
                              </div>
                          </div>
                          ...
                          <div className="mt-auto w-full border-t border-slate-200 pt-6 flex justify-between items-end text-left">
                              <div>
                                  <div className="text-xs text-slate-400 uppercase font-bold">Certificate ID</div>
                                  <div className="font-mono text-slate-700">CERT-8921-NDPR-2024</div>
                              </div>
                              <div className="text-right">
                                  <img src="https://upload.wikimedia.org/wikipedia/commons/f/fa/Signature_sample.svg" alt="Signature" className="h-8 mb-1 opacity-50" />
                                  <div className="text-xs text-slate-400 uppercase font-bold">Chief Compliance Officer</div>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div className="bg-slate-900 w-full max-w-3xl rounded-2xl shadow-2xl relative flex flex-col max-h-[85vh] border border-slate-800">
                      ...
                      <div className="flex items-center justify-between p-6 border-b border-slate-800 bg-slate-950/50 rounded-t-2xl">
                          <div className="flex items-center gap-3">
                              ...
                              <div>
                                  <h3 className="text-xl font-bold text-slate-100">Technical Whitepaper</h3>
                                  <p className="text-xs text-slate-500">Protocol v2.1 • Zero-Knowledge Architecture</p>
                              </div>
                          </div>
                          <button onClick={close} className="p-2 text-slate-500 hover:text-white hover:bg-slate-800 rounded-full transition-colors">
                              <X size={20} />
                          </button>
                      </div>
                      ...
                      <div className="p-8 overflow-y-auto prose prose-invert max-w-none prose-sm">
                          ...
                          <p className="text-slate-400">
                              This paper introduces the WelliRecord Protocol, a decentralized framework for health data interoperability that prioritizes patient sovereignty through Zero-Knowledge Proofs (ZKPs). By utilizing client-side encryption and verifiable credentials, WelliRecord ensures that no central authority—including WelliCare itself—ever possesses the decryption keys to raw patient data.
                          </p>
                          ...
                          <div className="my-8 p-6 bg-slate-950 border border-slate-800 rounded-xl flex items-center justify-center">
                              ...
                              <div className="flex items-center gap-4 text-xs font-bold text-slate-500">
                                  ...
                                  <div className="h-px w-12 bg-slate-700 relative">
                                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 text-[9px] bg-slate-900 px-1">Encrypted Blob</div>
                                  </div>
                                  <div className="flex flex-col items-center gap-2">
                                  ...
                                  <div className="h-px w-12 bg-slate-700 relative">
                                      <div className="absolute -top-3 left-1/2 -translate-x-1/2 text-[9px] bg-slate-900 px-1">ZKP Proof</div>
                                  </div>
                                  <div className="flex flex-col items-center gap-2">
                          ...
                          <p className="text-slate-400">
                              WelliRecord employs zk-SNARKs to allow patients to prove eligibility (e.g., insurance coverage, age requirement) without revealing underlying data. For instance, a patient can prove they are over 18 without revealing their exact birth date.
                          </p>

                          <h3 className="text-white">2.0 Client-Side Encryption</h3>
                          <p className="text-slate-400">
                              All health records are encrypted on the user's device using AES-256-GCM before transmission. The private key is derived from the user's master seed phrase and never leaves the local environment.
                          </p>
                      </div>
                  ...
                  <div className="w-full max-w-5xl bg-slate-950 border border-slate-800 rounded-xl shadow-2xl overflow-hidden flex flex-col h-[80vh]">
                      ...
                      <div className="flex items-center justify-between px-6 py-4 border-b border-slate-800 bg-black">
                          <div className="flex items-center gap-4">
                              ...
                              <span className="text-slate-400 text-sm ml-4">admin@wellichain-mainnet:~</span>
                          </div>
                      ...
                      <div className="p-8 flex-1 overflow-y-auto">
                          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                              <div className="p-4 border border-emerald-500/30 bg-emerald-900/10 rounded-lg">
                                  <div className="text-xs text-emerald-500 uppercase mb-1">Network Status</div>
                              ...
                              <div className="p-4 border border-slate-800 bg-slate-900/50 rounded-lg">
                                  <div className="text-xs text-slate-500 uppercase mb-1">Block Height</div>
                                  <div className="text-2xl font-bold text-blue-400">#12,894,021</div>
                              </div>
                              <div className="p-4 border border-slate-800 bg-slate-900/50 rounded-lg">
                                  <div className="text-xs text-slate-500 uppercase mb-1">Validator Nodes</div>
                                  <div className="text-2xl font-bold text-purple-400 flex items-center gap-2">
                                      <Server size={20} /> 128
                                  </div>
                              </div>
                              <div className="p-4 border border-slate-800 bg-slate-900/50 rounded-lg">
                                  <div className="text-xs text-slate-500 uppercase mb-1">Avg Block Time</div>
                          ...
                          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                              ...
                              <div className="lg:col-span-2 border border-slate-800 rounded-lg bg-black/50 overflow-hidden">
                                  <div className="px-4 py-3 border-b border-slate-800 bg-slate-900/50 text-xs font-bold text-slate-400 uppercase flex justify-between">
                                      ...
                                      <span className="flex items-center gap-1"><span className="w-2 h-2 rounded-full bg-green-500 animate-pulse"></span> Streaming</span>
                                  </div>
                                  <div className="p-4 space-y-2 font-mono text-xs">
                                      {[...Array(8)].map((_, i) => (
                                          <div key={i} className="flex justify-between items-center text-slate-500 animate-in slide-in-from-right-4 fade-in duration-500" style={{animationDelay: `${i * 100}ms`}}>
                                              <span className="text-blue-500">0x{Math.random().toString(16).substr(2, 8)}...{Math.random().toString(16).substr(2, 4)}</span>
                              ...
                              <div className="border border-slate-800 rounded-lg bg-black/50 p-6 flex flex-col items-center justify-center relative overflow-hidden">
                                  ...
                                  <div className="relative z-10 w-48 h-48">
                                      ...
                                      {/* Orbiting Nodes */}
                                      {[...Array(6)].map((_, i) => (
                                          <div key={i} className="absolute top-1/2 left-1/2 w-2 h-2 bg-slate-600 rounded-full" 
                                              style={{
                                                  transform: `translate(-50%, -50%) rotate(${i * 60}deg) translateX(${80}px) rotate(-${i * 60}deg)`
                                              }}
                                          >
                                              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-24 h-px bg-slate-800 -z-10 origin-left" style={{ transform: `rotate(${i * 60 + 180}deg)` }}></div>
                                          </div>
                                      ))}
                                      <div className="absolute inset-0 border border-slate-800/50 rounded-full animate-spin-slow"></div>
                                  </div>
                                  <p className="mt-4 text-xs text-slate-500 text-center">Decentralized Storage Topology</p>
                              </div>
                          </div>
                      </div>
                  </div>
            ...
            <div className="px-8 py-6 border-b border-slate-100 flex justify-between items-center bg-slate-50/50">
                <div>
                    <h3 className="text-xl font-bold text-slate-900">
                        {wizardStep === 0 ? "Select Setup Method" : wizardStep >= 5 ? "Smart Contract Setup" : "Create Secure ID"}
                    </h3>
                    <p className="text-sm text-slate-500">
                        {wizardStep === 0 ? "Choose how you want to secure your data" : wizardStep >= 5 ? `Phase ${wizardStep - 4} of 4` : `Step ${wizardStep} of 4`}
                    </p>
                </div>
                    ...
                    <div className="space-y-4 animate-in slide-in-from-right-4 duration-300">
                        ...
                        >
                            <div className="flex items-start gap-4 relative z-10">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-slate-900">Standard Account</h4>
                                    <p className="text-sm text-slate-500 mt-1">Sign up with email and password. Easy recovery, managed security.</p>
                                </div>
                            </div>
                        </button>
                        ...
                        >
                            <div className="flex items-start gap-4 relative z-10">
                                ...
                                <div>
                                    <h4 className="text-lg font-bold text-slate-900">Smart Contract Identity</h4>
                                    <p className="text-sm text-slate-500 mt-1">Generate a self-sovereign blockchain wallet. Max privacy, you hold the keys.</p>
                                </div>
                            </div>
                        </button>
                    </div>
                ...
                {wizardStep === 1 ? (
                    <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
                        <div className="space-y-2">
                            ...
                            <div className="relative">
                                <User className={`absolute left-4 top-3.5 ${errors.name && touched.name ? 'text-red-400' : 'text-slate-400'}`} size={18} />
                                <input 
                                    type="text" 
                                    name="name"
                            ...
                            {errors.name && touched.name && <p className="text-xs text-red-500 font-medium ml-1 flex items-center gap-1"><AlertCircle size={12}/> {errors.name}</p>}
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700">Email Address</label>
                            <div className="relative">
                                <Mail className={`absolute left-4 top-3.5 ${errors.email && touched.email ? 'text-red-400' : 'text-slate-400'}`} size={18} />
                                <input 
                                    type="email" 
                                    name="email"
                            ...
                            {errors.email && touched.email && <p className="text-xs text-red-500 font-medium ml-1 flex items-center gap-1"><AlertCircle size={12}/> {errors.email}</p>}
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700">Mobile Phone</label>
                            <div className="relative">
                                <Smartphone className={`absolute left-4 top-3.5 ${errors.phone && touched.phone ? 'text-red-400' : 'text-slate-400'}`} size={18} />
                                <input 
                                    type="tel" 
                                    name="phone"
                            ...
                            {errors.phone && touched.phone && <p className="text-xs text-red-500 font-medium ml-1 flex items-center gap-1"><AlertCircle size={12}/> {errors.phone}</p>}
                        </div>
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700">Create Password</label>
                            <div className="relative">
                                <Lock className={`absolute left-4 top-3.5 ${errors.password && touched.password ? 'text-red-400' : 'text-slate-400'}`} size={18} />
                                <input 
                                    type="password" 
                                    name="password"
                                    placeholder="••••••••••••"
                            ...
                            {errors.password && touched.password && <p className="text-xs text-red-500 font-medium ml-1 flex items-center gap-1"><AlertCircle size={12}/> {errors.password}</p>}
                        </div>
                    </div>
                ) : wizardStep === 2 ? (
                    <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                        <div className="text-center">
                            ...
                            <p className="text-slate-500 text-sm px-4">
                                To comply with healthcare regulations, we need to verify your identity. Please enter your 11-digit National Identification Number (NIN).
                            </p>
                        </div>

                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700">National ID Number (NIN)</label>
                            <div className="relative">
                                <ShieldCheck className={`absolute left-4 top-3.5 ${errors.nin && touched.nin ? 'text-red-400' : 'text-slate-400'}`} size={18} />
                                <input 
                                    type="text" 
                                    name="nin"
                            ...
                            {errors.nin && touched.nin && <p className="text-xs text-red-500 font-medium ml-1 flex items-center gap-1"><AlertCircle size={12}/> {errors.nin}</p>}
                        </div>
                        
                        <div className="bg-blue-50 p-4 rounded-xl border border-blue-100 flex items-start gap-3">
                            <Lock size={16} className="text-blue-500 shrink-0 mt-0.5" />
                            <p className="text-xs text-blue-600 leading-relaxed">
                                Your NIN is encrypted instantly and used solely for identity verification. It is not stored on our servers in plain text.
                            </p>
                        </div>
                    </div>
                ) : wizardStep === 3 ? (
                    <div className="space-y-6 animate-in slide-in-from-right-4 duration-300 text-center">
                        ...
                        <p className="text-slate-500 text-sm px-4">
                            We sent a verification code to the phone number linked to your NIN (**89). Enter it below to secure your account.
                        </p>
                    ...
                    <div className="space-y-6 animate-in slide-in-from-right-4 duration-300 text-center">
                        ...
                        <h3 className="text-lg font-bold text-slate-900">Finalizing Your Vault</h3>
                        <p className="text-slate-500 text-sm">
                            We are generating your unique cryptographic keys. You will be the only person with access to your raw health data.
                        </p>
                        ...
                        <div className="bg-slate-50 p-4 rounded-xl text-left border border-slate-100">
                            <label className="flex items-start gap-3 cursor-pointer">
                                ...
                                <span className="text-sm text-slate-600 leading-relaxed">
                                    I understand that WelliRecord cannot recover my data if I lose my private key, as we do not store it. I agree to the <a href="#" className="text-blue-600 font-medium underline">Terms of Service</a>.
                                </span>
                            </label>
                        </div>
                    </div>
                    ...
                    <div className="space-y-5 animate-in slide-in-from-right-4 duration-300">
                        <div className="p-4 bg-purple-50 rounded-xl border border-purple-100 mb-4 flex gap-3">
                            ...
                            <div className="text-sm text-purple-900">
                                <strong>Blockchain Identity:</strong> You are creating a self-sovereign identity. No email or password required. You will sign in using your cryptographic key.
                            </div>
                        </div>
                        ...
                        <div className="space-y-2">
                            <label className="text-sm font-bold text-slate-700">National ID (NIN) for Binding</label>
                            <input 
                                type="text" 
                                name="nin"
                                ...
                                onChange={handleInputChange}
                            />
                            <p className="text-xs text-slate-500">Your NIN will be hashed and bound to your smart contract.</p>
                        </div>
                    </div>
                ) : wizardStep === 6 ? (
                    <div className="space-y-8 animate-in slide-in-from-right-4 duration-300 py-4">
                        <div className="flex flex-col items-center justify-center space-y-4">
                            <div className="relative">
                                <div className="w-24 h-24 rounded-full border-4 border-slate-100 flex items-center justify-center">
                                    {contractStatus === 'idle' && <Cpu size={40} className="text-slate-300" />}
                                    {contractStatus === 'compiling' && <Binary size={40} className="text-purple-500 animate-pulse" />}
                                    {contractStatus === 'deploying' && <Server size={40} className="text-blue-500 animate-bounce" />}
                                    {contractStatus === 'minting' && <Fingerprint size={40} className="text-emerald-500 animate-pulse" />}
                                    {contractStatus === 'done' && <CheckCircle size={48} className="text-emerald-500" />}
                                </div>
                                {(contractStatus === 'deploying' || contractStatus === 'compiling') && (
                            ...
                            <div className="text-center space-y-1">
                                <h3 className="text-xl font-bold text-slate-900">
                                    ...
                                    {contractStatus === 'compiling' && "Generating Identity Keys..."}
                                    {contractStatus === 'deploying' && "Deploying to WelliChain..."}
                                    {contractStatus === 'minting' && "Minting Soulbound Token..."}
                                    {contractStatus === 'done' && "Deployment Complete"}
                                </h3>
                                <p className="text-sm text-slate-500 font-mono">
                                    {contractStatus === 'deploying' && "Block #12,894,221 • 2 Confirmations"}
                                    {contractStatus === 'minting' && "Binding NIN Hash: 0x9f...a1"}
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="bg-slate-900 rounded-xl p-4 font-mono text-xs text-green-400 h-40 overflow-hidden relative">
                            ...
                            <div className="space-y-1 opacity-80">
                                ...
                                {contractStatus !== 'idle' && <p> Public Key Generated: 0x71C...9A21</p>}
                                {(contractStatus === 'deploying' || contractStatus === 'minting' || contractStatus === 'done') && (
                                    <>
                                        <p> Compiling SmartContract.sol...</p>
                                        <p> Deploying to Network (Gas: 0.002 ETH)...</p>
                                        <p className="text-blue-400"> Transaction Hash: 0x3b1...c99e</p>
                                    </>
                                )}
                                {contractStatus === 'done' && (
                                    <p className="text-white font-bold"> CONTRACT DEPLOYED SUCCESSFULLY</p>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="space-y-6 animate-in slide-in-from-right-4 duration-300">
                        <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex gap-3">
                            ...
                            <div className="text-sm text-amber-900">
                                <strong>Save this immediately.</strong> This is the only way to recover your account. We do not store your private key.
                            </div>
                        </div>

                        <div className="space-y-3">
                            <label className="text-xs font-bold text-slate-500 uppercase">Your Contract Address</label>
                            <div className="flex items-center gap-2 bg-slate-100 p-3 rounded-xl border border-slate-200">
                                <Hash size={16} className="text-slate-400" />
                                <code className="text-sm font-mono text-slate-700 flex-1 truncate">{generatedAddress}</code>
                            </div>
                        </div>

                        <div className="space-y-3">
                            <label className="text-xs font-bold text-slate-500 uppercase">Secret Recovery Phrase</label>
                        ...
                        <div className="flex items-start gap-3">
                            <input 
                                ...
                                onChange={e => setFormData({...formData, agreeToTerms: e.target.checked})}
                            />
                            <label htmlFor="saved-phrase" className="text-sm text-slate-600 cursor-pointer">
                                I have saved my recovery phrase in a secure location. I understand that WelliRecord cannot recover my account if I lose this phrase.
                            </label>
                        </div>
                    </div>
                ) : null}
                ...
                {loginMethod === 'email' ? (
                    loginStep === 1 ? (
                        <form onSubmit={handleLoginCredentialsSubmit} className="space-y-4">
                            <div className="space-y-2">
                                <label className="text-xs font-bold text-slate-700 uppercase">Email or Member ID</label>
                                <input 
                                    type="text" 
                                    required
                        ...
                        <form onSubmit={handleLoginVerifySubmit} className="space-y-6">
                             <div className="text-center">
                                <p className="text-sm text-slate-600 mb-4">
                                    Enter the 6-digit code from your authenticator app or sent to ••89.
                                </p>
                                <input 
                                    type="text" 
                                    maxLength={6}
                    ...
                    <div className="space-y-6 text-center animate-in fade-in slide-in-from-right-4">
                        <div className="py-2">
                            <div className="w-20 h-20 bg-purple-50 rounded-full flex items-center justify-center mx-auto mb-4 border-2 border-purple-100">
                                {walletStatus === 'idle' && <Wallet size={32} className="text-purple-600" />}
                                {walletStatus === 'connecting' && <Loader2 size={32} className="text-purple-600 animate-spin" />}
                                {(walletStatus === 'checking' || walletStatus === 'deploying') && <Cpu size={32} className="text-purple-600 animate-pulse" />}
                                {walletStatus === 'connected' && <CheckCircle2 size={32} className="text-emerald-500" />}
                            </div>
                            ...
                            <h4 className="font-bold text-slate-900 text-lg">
                                ...
                                {walletStatus === 'deploying' && "Auto-Generating Contract..."}
                                {walletStatus === 'connected' && "Identity Confirmed"}
                            </h4>
                            
                            <p className="text-sm text-slate-500 mt-2 min-h-[40px]">
                                {walletStatus === 'idle' && "Sign in or create a patient identity automatically using your blockchain wallet."}
                                {walletStatus === 'connecting' && "Please approve the connection request in your wallet app."}
                                {walletStatus === 'checking' && "Checking WelliChain for existing patient record..."}
                                {walletStatus === 'deploying' && "No record found. Deploying new Patient Smart Contract to blockchain..."}
                                {walletStatus === 'connected' && "Redirecting to your secure dashboard..."}
                            </p>
                        </div>
                        ...
                        <div className="text-xs text-slate-400 bg-slate-50 p-3 rounded-lg border border-slate-100">
                            <strong>Note:</strong> Connecting a new wallet will automatically initialize a patient setup smart contract.
                        </div>
                    </div>
                )}
            </div>
            ...
            {loginMethod === 'email' && (
                <div className="p-4 border-t border-slate-100 bg-slate-50 text-center">
                    <p className="text-xs text-slate-500">
                        Don't have an account? <button onClick={handleStartWizard} className="text-blue-600 font-bold hover:underline">Create one</button>
                    </p>
                </div>
            )}
        </div>
      ...
      return (
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4 animate-in fade-in zoom-in-95 duration-300">
            <div className="bg-white w-full max-w-2xl rounded-2xl shadow-2xl overflow-hidden flex flex-col max-h-[90vh]">
                <div className={`p-8 ${activeFeature.modalColor} text-white relative`}>
                    <button 
                    ...
                    <p className="text-white/90 text-lg leading-relaxed">{activeFeature.desc}</p>
                </div>
                
                <div className="p-8 overflow-y-auto">
                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wide mb-3">Deep Dive</h4>
                    <p className="text-slate-600 leading-relaxed mb-8">
                        {activeFeature.details}
                    </p>
                    
                    <h4 className="text-sm font-bold text-slate-900 uppercase tracking-wide mb-3">Key Benefits</h4>
                    <div className="space-y-3">
                        {activeFeature.benefits.map((benefit: string, i: number) => (
                            <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-slate-50 border border-slate-100">
                                <CheckCircle2 className={`shrink-0 mt-0.5 ${activeFeature.color.split(' ')[1]}`} size={18} />
    ...
    <div className="min-h-screen bg-white font-sans text-slate-900 selection:bg-blue-100">
       ...
       <nav className="sticky top-0 z-40 bg-white/80 backdrop-blur-md border-b border-slate-100">
           <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
               <div className="flex items-center gap-2.5">
                   <div className="w-8 h-8 text-blue-600">
                       <svg viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
                          <path d="M50 95C50 95 85 78.4 85 45V18L50 5L15 18V45C15 78.4 50 95 50 95Z" fill="currentColor" />
                          <path d="M50 25V65M30 45H70" stroke="white" strokeWidth="8" strokeLinecap="round" />
                       </svg>
                   </div>
                   <span className="text-xl font-bold tracking-tight text-slate-900">WelliRecord</span>
               </div>
               ...
               <div className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
                   ...
                   <a href="#security" onClick={(e) => scrollToSection(e, 'security')} className="hover:text-blue-600 transition-colors">Security</a>
                   <a href="#partners" onClick={(e) => scrollToSection(e, 'partners')} className="hover:text-blue-600 transition-colors">Partners</a>
               </div>
           ...
           <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
               <div className="space-y-8">
                   ...
                   <h1 className="text-5xl md:text-6xl font-extrabold text-slate-900 leading-[1.1] tracking-tight">
                       Your complete medical history, <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-emerald-600">accessible anywhere.</span>
                   </h1>
                   <p className="text-xl text-slate-500 leading-relaxed max-w-xl">
                       Stop chasing down faxed records. WelliRecord connects your doctors, labs, and wearables into one secure timeline—owned completely by you.
                   </p>
                   ...
                   <div className="flex flex-col sm:flex-row gap-4">
                       ...
                       <button 
                        ...
                        >
                           <Play size={18} fill="currentColor" className="text-slate-400" /> Watch Demo
                       </button>
                   </div>
                   ...
                   <div className="relative w-full max-w-md aspect-[3/4] bg-slate-900 rounded-[2.5rem] shadow-2xl border-8 border-slate-900 overflow-hidden ring-1 ring-slate-900/5">
                       ...
                       <div className="absolute bottom-8 left-6 right-6 bg-white/10 backdrop-blur-md border border-white/20 p-4 rounded-xl flex items-center gap-3">
                           ...
                           <div className="text-white">
                               ...
                               <div className="text-xs opacity-80">Mount Sinai Hospital • Just now</div>
                           </div>
                       </div>
                   </div>

                   {/* Decorative Elements around phone */}
                   <div className="absolute top-1/4 -right-12 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 flex items-center gap-3 animate-bounce" style={{ animationDuration: '3s' }}>
                        <div className="bg-blue-100 p-2 rounded-lg text-blue-600"><Activity size={20} /></div>
                        <div>
                            <div className="text-xs font-bold text-slate-500 uppercase">Vitals</div>
       ...
       <section className="border-y border-slate-100 bg-slate-50 py-16" id="partners">
           <div className="max-w-7xl mx-auto px-6 text-center">
               <p className="text-sm font-bold text-slate-400 uppercase tracking-widest mb-10">Trusted by Top Nigerian Healthcare Providers</p>
               <div className="flex flex-wrap justify-center gap-6 md:gap-12">
                   {/* Nigerian Hospitals - Interactive Links */}
                   {['Lagoon Hospitals', 'Reddington Hospital', 'Eko Hospital', 'First Cardiology', 'Cedarcrest Hospitals'].map((name, i) => (
                       <button 
                           key={i} 
                           onClick={() => alert(`Initiating secure connection request to ${name} Portal...`)}
                       ...
                       >
                           ...
                           <span className="text-lg font-serif font-bold text-slate-700 group-hover:text-slate-900">{name}</span>
                       </button>
                   ))}
               </div>
           </div>
       ...
       <section className="py-24" id="features">
           <div className="max-w-7xl mx-auto px-6">
               <div className="text-center max-w-3xl mx-auto mb-20">
                   <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Everything you need to manage your health</h2>
                   <p className="text-lg text-slate-500">Traditional patient portals are fragmented. WelliRecord brings it all together in one beautiful, secure dashboard.</p>
               </div>

               <div className="grid md:grid-cols-3 gap-8">
                   {FEATURES.map((feature, i) => (
                       <div key={i} className="bg-slate-50 rounded-3xl p-8 border border-slate-100 hover:shadow-xl transition-all duration-300 group hover:-translate-y-1">
       ...
       <section className="py-24 bg-slate-900 text-white border-y border-slate-800" id="security">
           <div className="max-w-7xl mx-auto px-6">
                <div className="text-center max-w-3xl mx-auto mb-16">
                   ...
                   <h2 className="text-3xl md:text-4xl font-bold mb-4">Your health data, secured like a vault.</h2>
                   <p className="text-lg text-slate-400">
                       We use military-grade encryption and decentralized storage to ensure that you—and only you—hold the keys to your medical history.
                   </p>
               </div>
               ...
               <div className="grid md:grid-cols-3 gap-8">
                   <div className="p-6 rounded-2xl bg-slate-800 border border-slate-700 hover:border-emerald-500/50 transition-colors flex flex-col">
                       ...
                       <p className="text-slate-400 text-sm leading-relaxed mb-6 flex-1">
                           Fully compliant with the Nigeria Data Protection Regulation (NDPR) and US HIPAA standards, ensuring your rights are protected globally.
                       </p>
                       <button onClick={() => setActiveSecurityFeature('certificate')} className="flex items-center gap-2 text-xs font-bold text-emerald-400 hover:text-emerald-300 uppercase tracking-wider">
                   ...
                   <div className="p-6 rounded-2xl bg-slate-800 border border-slate-700 hover:border-blue-500/50 transition-colors flex flex-col">
                       ...
                       <p className="text-slate-400 text-sm leading-relaxed mb-6 flex-1">
                           Your data is encrypted on your device before it ever touches our servers. We cannot see your records, even if we wanted to.
                       </p>
                       <button onClick={() => setActiveSecurityFeature('whitepaper')} className="flex items-center gap-2 text-xs font-bold text-blue-400 hover:text-blue-300 uppercase tracking-wider">
                   ...
                   <div className="p-6 rounded-2xl bg-slate-800 border border-slate-700 hover:border-purple-500/50 transition-colors flex flex-col">
                       ...
                       <p className="text-slate-400 text-sm leading-relaxed mb-6 flex-1">
                           Your records are stored on the WelliChain, an immutable ledger. You grant and revoke access permissions in real-time.
                       </p>
                       <button onClick={() => setActiveSecurityFeature('network')} className="flex items-center gap-2 text-xs font-bold text-purple-400 hover:text-purple-300 uppercase tracking-wider">
       ...
       <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
           ...
           <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-16 items-center relative z-10">
               <div>
                   ...
                   <h2 className="text-3xl md:text-4xl font-bold mb-6">Medical jargon, translated into plain English.</h2>
                   <p className="text-lg text-slate-300 mb-8 leading-relaxed">
                       Don't just read your lab results—understand them. WelliRecord's AI assistant analyzes complex clinical notes and explains them simply, highlighting what actually matters for your health.
                   </p>
               ...
               <div className="bg-slate-800 rounded-2xl border border-slate-700 p-6 shadow-2xl relative">
                   <div className="flex gap-4 mb-6">
                       ...
                       <div className="bg-slate-700 rounded-2xl rounded-tl-none p-4 text-sm text-slate-200 leading-relaxed shadow-sm">
                           ...
                           <p><strong>Good news:</strong> Your Kidney Function (eGFR) has improved by 15% since last year. However, your Vitamin D is slightly low (28 ng/mL).</p>
                           <p className="mt-2 text-blue-300 cursor-pointer hover:underline">View suggested supplements &rarr;</p>
                       </div>
                   </div>
       ...
       <section className="py-20 border-t border-slate-100">
           <div className="max-w-4xl mx-auto px-6 text-center">
               <h2 className="text-3xl font-bold text-slate-900 mb-6">Ready to take control of your health?</h2>
               <p className="text-slate-500 mb-10 text-lg">Join thousands of patients who have already secured their medical future.</p>
               ...
               <p className="mt-8 text-xs text-slate-400">
                   WelliRecord complies with NDPR, HIPAA, GDPR, and SOC2 Type II standards. Your data is encrypted at rest and in transit.
               </p>
           </div>
       </section>
    </div>
