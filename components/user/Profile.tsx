...
import { PersonalInformationCard } from "../layout/PersonalInformationCard";
    ...
    <div className="max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 pb-12">
      ...
      <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-slate-900 rounded-2xl p-6 border border-slate-800 flex flex-col items-center text-center relative overflow-hidden group">
            ...
            <div className="w-full pt-4 border-t border-slate-800">
              <div className="flex items-center justify-between text-sm mb-2">
                ...
                <span className="text-emerald-400 font-bold bg-emerald-900/20 px-2 py-0.5 rounded border border-emerald-900/30">
                  Active
                </span>
              </div>
              <div className="flex items-center justify-between text-sm">
                <span className="text-slate-400">Plan</span>
                <span className="text-amber-400 font-bold bg-amber-900/20 px-2 py-0.5 rounded border border-amber-900/30">
                  Premium
                </span>
              </div>
              {ninStatus === "verified" && (
        ...
        <div className="md:col-span-2 space-y-6">
          ...
          <div
            className={`rounded-2xl border p-6 transition-all duration-300 ${ninStatus === "verified" ? "bg-emerald-900/10 border-emerald-500/30" : "bg-slate-900 border-slate-800"}`}
          >
            <div className="flex items-center justify-between mb-6">
              <h3
                className={`font-bold text-lg flex items-center gap-2 ${ninStatus === "verified" ? "text-emerald-400" : "text-slate-100"}`}
              >
                {ninStatus === "verified" ? (
                  <ShieldCheck />
                ) : (
            ...
            {ninStatus === "verified" ? (
              <div className="text-sm text-slate-400 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p>
                    ...
                    linked to your WelliRecord profile.
                  </p>
                </div>
              </div>
            ) : (
              <div className="space-y-6">
                <p className="text-sm text-slate-400">
                  To comply with healthcare regulations, please verify your
                  identity by entering your National Identification Number
                  (NIN). We will send a one-time code to your registered phone
                  number.
                </p>
                  ...
                  <div className="mt-2 p-4 bg-slate-950/50 rounded-xl border border-slate-800 text-xs text-slate-400 space-y-3 animate-in fade-in slide-in-from-top-1">
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        Your private key is your identity. Never share it with
                    ...
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        Check your 'Portability' tab monthly to revoke access
                        for providers you no longer see.
                      </div>
                    </div>
                    <div className="flex gap-3">
                      ...
                      <div>
                        ...
                        Enable biometric login to prevent unauthorized access if
          ...
          <div className="bg-slate-900 rounded-2xl border border-slate-800 p-6">
            <h3 className="font-bold text-slate-100 mb-6 flex items-center gap-2">
              <QrCode className="text-purple-500" /> WelliID Smart Contract
              Binding
            </h3>
            ...
            <div className="flex flex-col sm:flex-row gap-6 items-center">
              <div className="bg-white p-2 rounded-xl shrink-0">
                <img
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=${formData.memberId}`}
                  alt="WelliID QR"
                  className="w-32 h-32"
                />
              </div>
